...
public class ChromeTest {
    ...
    void openDefaultMode() {
        ...
        Assert.assertEquals(driver.getTitle(),"Selenium");// kiểm tra title của web
        driver.quit();
    }
    ...
    void openHeadlessMode(){
        ...
        chromeOptions.addArguments("--headless=new");//dùng env headless để giảm tải ram và có thể quay video
    ...
    //Test responsive web (kích thước)
    @Test
